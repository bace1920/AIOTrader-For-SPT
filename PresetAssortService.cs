...
[Injectable(InjectionType.Singleton, TypePriority = OnLoadOrder.TraderRegistration + 99999 + 1)]
...
) : IOnLoad
{
    ...
    {
        if (!tradersTable.TryGetValue(AioTraderId, out var trader) || trader.Assort == null)
        {
